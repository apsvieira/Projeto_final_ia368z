...
def main():
    ...
    parser.add_argument(
        '--decay',
        help='Decay of the label_smoother on each epoch',
        required=True
    )
    parser.add_argument(
        '--outputDir',
        help='Directory where the pictures will be saved',
        required=True
    )
    ...
    if(arguments['real_labelSmooth']):
        real_labelSmooth = float(arguments['real_labelSmooth'])
    else:
        print("real_labelSmooth will be set as 0.3")
    ...
    if (arguments['decay']):
        ...
        decay = 0.25
        print('Decay will be set to 0.25')
